...
import { CategoryItem, ReactMouseEvent, ReactSubmitEvent, ReactDragEvent } from '../types/index';
import { getNotes, getCategories, getSettings } from '../selectors/index';
import { TestID } from '../assets/TestID';
import { determineCategoryClass } from '../utils/helper';
...
/**
 * Category Option Show under Category List
 */
