...
import { LastSyncedNotification } from '../component/LastSyncedNotification';
import { NoteItem, CategoryItem } from '../types/index';
import {
  toggleSettingsModal,
...
import { getCategories, getNotes, getSync, getSettings } from '../selectors/index';
import { downloadNotes, isDraftNote, getShortUuid, copyToClipboard } from '../utils/helper';
